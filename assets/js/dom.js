(() => {
  ...
  const els = {
    ...
    scheduleProgramUnairedOnly: document.getElementById('schedule-program-unaired-only'),
    scheduleProgramRightsStartYearOnly: document.getElementById('schedule-program-rights-start-year-only'),
    scheduleProgramTopEarnerOnly: document.getElementById('schedule-program-top-earner-only'),
