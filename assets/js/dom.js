(() => {
  ...
  const els = {
    ...
    detailTimingEditor: document.getElementById('detail-timing-editor'),
    detailExtraFieldsEditor: document.getElementById('detail-extra-fields-editor'),
    detailAddTimingRowButton: document.getElementById('detail-add-timing-row-button'),
    ...
    scheduleMobileDailyRundownButton: document.getElementById('schedule-mobile-daily-rundown-button'),
    scheduleMobilePrintCalendarButton: document.getElementById('schedule-mobile-print-calendar-button'),
    newScheduleButton: document.getElementById('new-schedule-button'),
    driveComparisonButton: document.getElementById('drive-comparison-button'),
    driveComparisonModal: document.getElementById('drive-comparison-modal'),
    driveComparisonBackdrop: document.getElementById('drive-comparison-backdrop'),
    driveComparisonCloseButton: document.getElementById('drive-comparison-close-button'),
    driveComparisonRefreshButton: document.getElementById('drive-comparison-refresh-button'),
    driveComparisonStartDate: document.getElementById('drive-comparison-start-date'),
    ...
    driveComparisonTable: document.getElementById('drive-comparison-table'),
    ...
    fundraiserGoalInput: document.getElementById('fundraiser-goal-input'),
    fundraiserBroadcastTotal: document.getElementById('fundraiser-broadcast-total'),
    fundraiserPledgesTotal: document.getElementById('fundraiser-pledges-total'),
    ...
    fundraiserNonSpecificTotal: document.getElementById('fundraiser-non-specific-total'),
    fundraiserGrandTotal: document.getElementById('fundraiser-grand-total'),
    fundraiserGoalDifference: document.getElementById('fundraiser-goal-difference'),
    ...
    scheduleFundraiserGraphButton: document.getElementById('schedule-fundraiser-graph-button'),
    fundraiserGraphModal: document.getElementById('fundraiser-graph-modal'),
    fundraiserGraphBackdrop: document.getElementById('fundraiser-graph-backdrop'),
    fundraiserGraphCloseButton: document.getElementById('fundraiser-graph-close-button'),
    fundraiserGraphRefreshButton: document.getElementById('fundraiser-graph-refresh-button'),
    fundraiserGraphChartView: document.getElementById('fundraiser-graph-chart-view'),
    ...
    schedulePrintCalendarButton: document.getElementById('schedule-print-calendar-button'),
    ...
    importAccountingPill: document.getElementById('import-accounting-pill'),
    importAccountingSummaryBody: document.getElementById('import-accounting-summary-body'),
    importAccountingBody: document.getElementById('import-accounting-body'),
    ...
    importRefreshQuarantineButton: document.getElementById('import-refresh-quarantine-button'),
    importQuarantineFilter: document.getElementById('import-quarantine-filter'),
    importQuarantinePreview: document.getElementById('import-quarantine-preview'),
    importSuspectPill: document.getElementById('import-suspect-pill'),
    importRefreshSuspectButton: document.getElementById('import-refresh-suspect-button'),
    importSuspectFilter: document.getElementById('import-suspect-filter'),
    importSuspectBody: document.getElementById('import-suspect-body'),
    importSuspectPreview: document.getElementById('import-suspect-preview'),
