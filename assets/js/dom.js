(() => {
  ...
  const els = {
    ...
    fundraiserStartMonth: document.getElementById('fundraiser-start-month'),
    fundraiserStartDay: document.getElementById('fundraiser-start-day'),
    fundraiserStartYear: document.getElementById('fundraiser-start-year'),
    fundraiserEndInput: document.getElementById('fundraiser-end-input'),
    fundraiserEndMonth: document.getElementById('fundraiser-end-month'),
    fundraiserEndDay: document.getElementById('fundraiser-end-day'),
    fundraiserEndYear: document.getElementById('fundraiser-end-year'),
