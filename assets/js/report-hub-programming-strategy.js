(() => {
  ...
  function installCard() {
    ...
    card.innerHTML = `
      <span class="report-card-number">05</span>
      <h2>Fundraiser Programming Strategy</h2>
      <p>Plan an upcoming drive from pre-drive WNMU evidence, current Program Library rights, seasonality, rest/exposure and programmer ratings.</p>
      <span class="report-card-link">Build strategy report →</span>`;
    hub.append(card);
    return true;
  }
