...
marker = "  function renderTopicDiagnostics(base, current) {\n"
if src.count(marker) != 1:
    raise SystemExit(f'renderTopicDiagnostics marker count {src.count(marker)}')

helpers = r'''  function factorPermutations(keys = []) {
