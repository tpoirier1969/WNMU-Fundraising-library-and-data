...
assert.match(reportHtml, /one-sheet-reports\.js\?v=0\.22\.119/);
assert.match(reportHtml, /one-sheet-analysis\.js\?v=0\.22\.119/);
assert.match(reportHtml, /one-sheet-reports\.css\?v=0\.22\.119/);
