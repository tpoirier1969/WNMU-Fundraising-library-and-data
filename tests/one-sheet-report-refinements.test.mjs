...
assert.match(reports, /Start-time performance: slots with sufficient historical evidence/);
...
assert.match(reportHtml, /one-sheet-reports\.js\?v=0\.22\.103/);
assert.match(reportHtml, /one-sheet-analysis\.js\?v=0\.22\.103/);
assert.match(reportHtml, /one-sheet-reports\.css\?v=0\.22\.103/);
