...
assert.match(reportHtml, /one-sheet-reports\.js\?v=0\.22\.128/);
assert.match(reportHtml, /one-sheet-analysis\.js\?v=0\.22\.128/);
assert.match(reportHtml, /one-sheet-reports\.css\?v=0\.22\.128/);
