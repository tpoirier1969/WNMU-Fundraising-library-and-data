...
assert.match(source, /dashed red least-squares trend line reports the long-term slope/);
...
assert.match(source, /style: \{ stroke: '#ff2020', dash: '', width: 2\.8 \}/);
assert.match(source, /style: \{ stroke: '#ff2020', dash: '9 4', width: 1\.4 \}/);
