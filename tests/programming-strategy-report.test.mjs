...
test('strategy report keeps heavy analysis off the browser UI thread and trims Supabase payloads', () => {
  ...
  assert.match(workerUi, /importScripts\('one-sheet-analysis\.js\?v=0\.22\.186', 'programming-strategy-analysis\.js\?v=0\.22\.210', 'programming-strategy-backtest\.js\?v=0\.22\.210'\)/);
