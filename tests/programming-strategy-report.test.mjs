...
test('strategy report keeps heavy analysis off the browser UI thread and trims Supabase payloads', () => {
  ...
  assert.match(reportUi, /new Worker\('assets\/js\/programming-strategy-worker\.js\?v=0\.22\.210'\)/);
  ...
  assert.match(workerUi, /importScripts\('one-sheet-analysis\.js\?v=0\.22\.186', 'programming-strategy-analysis\.js\?v=0\.22\.209', 'programming-strategy-backtest\.js\?v=0\.22\.210'\)/);
